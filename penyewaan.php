<?php 
    ...
    if(!isset($_SESSION['username'])) {
        ...
        $record=mysqli_query($kon, "SELECT * FROM user WHERE username='$username'");
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index.php" class="logo">
      ...
      <span class="logo-mini"><img src="img/Logo.png" style="width:120px"></span>
