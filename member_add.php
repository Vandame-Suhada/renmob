      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="member.php"><img src="img/member.png" style="width: 15px"> Member</a></li>
                  ...
                  <div class="box-header">
                    <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <center>
                            <h3>Tambah Data Member</h3><hr>
                          </center><form action="member_add_proses.php" class="form-conatiner text-white" method="POST">
                        <div class="form-group">
                          <label>Nama Lengkap:</label>
                            <div class="input-group">
                              ...
                              <input name="nama_lengkap" type="text" class="form-control" id="merek_mobil" placeholder="Nama Lengkap" onkeyup="sum();" required />
                            </div>
                          </div>
                        <div class="form-group">
                          <label>No Telp:</label>
                            <div class="input-group">
                              ...
                              <input name="no_telp" type="text" class="form-control" id="unit_total" placeholder="No Telp" onkeyup="sum();" required />
                            </div>
                          </div>
                          <div class="form-group">
                          <label>Jenis Kelamin:</label>
                            <div class="input-group">
                                  <input class="form-check-input" type="radio" name="jenis_kelamin" id="radio" value="Laki-laki"> Laki-laki &nbsp;
                                  <input class="form-check-input" type="radio" name="jenis_kelamin" id="radio" value="Perempuan"> Perempuan
                            </div>
                          </div>
                        <div class="form-group">
                          <label>Alamat:</label>
                            <div class="input-group">
                              ...
                              <textarea name="alamat" class="form-control" id="unit_total" placeholder="Alamat"></textarea>
                            </div>
                          </div>
                          <center>
                            <input type="submit" class="btn btn-success" name="sub" value="Simpan Data">
                            <a href="member.php" class="btn btn-danger" name="sub">Kembali</a>
                          </center>
                        </form>
                        <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      </div>
