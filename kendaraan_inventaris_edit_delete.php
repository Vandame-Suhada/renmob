<?php 
    ...
    include("koneksi.php");
    if ($aksi=='Delete'){
      mysqli_query($kon, "DELETE FROM kendaraan_inventaris WHERE id='$id'");
      header('location:kendaraan_inventaris.php');
    }
    else if($aksi=='Edit'){
      $record=mysqli_query($kon,"SELECT * FROM kendaraan_inventaris WHERE id='$id'");
                  ...
                  <div class="box-header">
                    <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <center>
                            <h3>Edit Data Kendaraan Inventaris</h3><hr>
                          </center><form action="kendaraan_inventaris_edit_proses.php" class="form-conatiner text-white" method="POST">
                        <div class="form-group">
                          <label>Merek Mobil:</label>
                            <div class="input-group">
                              ...
                              <input name="merek_mobil" type="text" class="form-control" id="merek_mobil" placeholder="Merek Mobil" value="<?php echo $data['merek_mobil'] ?>" onkeyup="sum();" required />
                            </div>
                          </div>
                        <div class="form-group">
                          <label>Total Unit:</label>
                            <div class="input-group">
                              ...
                              <input name="unit_total" type="text" class="form-control" id="unit_total" placeholder="Total Unit" value="<?php echo $data['unit_total'] ?>" onkeyup="sum();" required />
                            </div>
                          </div>
                          <div class="form-group">
                          <label>Unit Tersedia:</label>
                            <div class="input-group">
                              ...
                              <input name="unit_tersedia" type="text" class="form-control" id="unit_tersedia" placeholder="Unit Tersedia" value="<?php echo $data['unit_tersedia'] ?>" onkeyup="sum();" required />
                            </div>
                          </div>
                          <div class="form-group">
                          <label>Harga/Hari:</label>
                            <div class="input-group">
                              ...
                              <input name="harga_sewa" type="text" class="form-control" id="harga_sewa" placeholder="Waktu Harga/Hari"  value="<?php echo $data['harga_sewa'] ?>" onkeyup="sum();" required />
                            </div>
                          </div>
                          <center>
