      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pengembalian.php"><img src="img/pengembalian.png" style="width: 15px">Pengembalian</a></li>
                  ...
                  <div class="box-header">
                    <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <center>
                            <h3>Tambah Data Pengembalian</h3><hr>
                          </center><form action="pengembalian_add_proses.php" class="form-conatiner text-white" method="POST">
                        <div class="form-group">
                          <label>Penyewa:</label>
                            <div class="input-group">
                              ...
                              <?php 
                               $record = mysqli_query($kon,"SELECT transaksi_penyewaan.id, member.nama_lengkap, transaksi_penyewaan.merek_mobil, transaksi_penyewaan.tgl_kembali FROM transaksi_penyewaan JOIN member ON transaksi_penyewaan.id_member=member.id");
                              while ($data = mysqli_fetch_array($record)) {?>
                              <option value="<?php echo $data['id'];?>"><?php echo $data['nama_lengkap'].'/ '.$data['merek_mobil'].'/ '.$data['tgl_kembali'];?></option>
                              <?php
                                }
                              ?>
                            </select>
                        ...
                        <div class="form-group">
                          <label>Ketepatan Waktu:</label>
                            <div class="input-group">
                              ...
                              <input name="ketepatan_waktu" type="text" class="form-control" id="ketepatan_waktu" placeholder="Ketepatan Waktu (Hari)" onkeyup="sum();" required />
                            </div>
                          </div>
                        <div class="form-group">
                          <label>Kerusakan:</label>
                            <div class="input-group">
                              ...
                              <input name="kerusakan" type="text" class="form-control" id="kerusakan" placeholder="Kerusakan" onkeyup="sum();" required />
                            </div>
                          </div>
                          <center>
                            <input type="submit" class="btn btn-success" name="sub" value="Simpan Data">
                            <a href="pengembalian.php" class="btn btn-danger" name="sub">Kembali</a>
                          </center>
                        </form>
                        <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      </div>
