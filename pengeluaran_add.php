      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li class="active"><a href="pengeluaran.php"><img src="img/pengeluaran.png" style="width: 15px"></i> Pengeluaran</a></li>
          </ul>
        </li>
                  ...
                  <div class="box-header">
                    <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <center>
                            <h3>Tambah Data Pengeluaran</h3><hr>
                          </center><form action="pengeluaran_add_proses.php" class="form-conatiner text-white" method="POST">
                        <div class="form-group">
                          <label>Tanggal:</label>
                            <div class="input-group">
                              ...
                              <input name="tanggal_pengeluaran" type="date" class="form-control" id="tanggal_pengeluaran" placeholder="Tanggal Pengeluaran" onkeyup="sum();" required />
                            </div>
                          </div>
                        <div class="form-group">
                          <label>Keperluan:</label>
                            <div class="input-group">
                              ...
                              <textarea name="keperluan" class="form-control" id="keperluan" placeholder="Keperluan" onkeyup="sum();" required></textarea> 
                            </div>
                          </div>
                        <div class="form-group">
                          <label>Total Pengeluaran:</label>
                            <div class="input-group">
                              ...
                              <input name="total_pengeluaran" type="text" class="form-control" id="total_pengeluaran" placeholder="Total Pengeluaran" onkeyup="sum();" required />
                            </div>
                          </div>
                          <center>
                            <input type="submit" class="btn btn-success" name="sub" value="Simpan Data">
                            <a href="pengeluaran.php" class="btn btn-danger" name="sub">Kembali</a>
                          </center>
                        </form>
                        <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      </div>
