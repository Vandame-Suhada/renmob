                  ...
                  <div class="box-header">
                    <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      <div class="col-md-6 col-sm-6 col-xs-12">
                          <center>
                            <h3>Tambah Data Transaksi Penyewaan</h3><hr>
                          </center><form action="penyewaan_add_proses.php" class="form-conatiner text-white" method="POST">
                        ...
                        <div class="form-group">
                          <label>Merek Mobil:</label>
                            <div class="input-group">
                              ...
                              while ($data = mysqli_fetch_array($record)) {?>
                              <option value="<?php echo $data['id'];?>"><?php echo $data['merek_mobil'];?></option>
                              <?php
                                }
                              ?>
                            </select>
                        ...
                        <div class="form-group">
                          <label>Sewa/Hari:</label>
                            <div class="input-group">
                              <div class="input-group-addon">
                                <i class="fa fa-book"></i>
                              </div>
                              <input name="sewa_hari" type="text" class="form-control" id="sewa_hari" placeholder="Sewa/Hari" onkeyup="sum();" required />
                            </div>
                          </div>
                          <div class="form-group">
                          <label>Waktu Penyewaan:</label>
                            <div class="input-group">
                              ...
                              <input name="tgl_sewa" type="date" class="form-control" id="waktu_penyewaan" placeholder="Waktu Penyewaan" onkeyup="sum();" required />
                            </div>
                          </div>
                          <div class="form-group">
                          <label>Batas Kembali:</label>
                            <div class="input-group">
                              ...
                              <input name="tgl_kembali" type="date" class="form-control" id="batas_kembali" placeholder="Batas Kembali" onkeyup="sum();" required />
                            </div>
                          </div>
                          <center>
                            <input type="submit" class="btn btn-success" name="sub" value="Simpan Data">
                            <a href="penyewaan.php" class="btn btn-danger" name="sub">Kembali</a>
                          </center>
                        </form>
                        <div class="col-md-3 col-sm-3 col-xs-6"></div>
                      </div>
